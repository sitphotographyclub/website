  ...
  return (
    ...
    <div className="text-light bg-black" style={{ background: "rgba(0,0,0,1)" }}>
      <Helmet>
        ...
        <meta
          name="keywords"
          content="SIT Photography Club, photography events, student photography, photography contests, photography exhibitions, photo club leadership, creative photography"
        />
        <meta property="og:title" content="About SIT Photography Club" />
        <meta
      ...
      <div className="container" id="about-us">
        ...
        <div className="row">
          <div className="col-12 text-center">
            ...
            <p>
              ...
              to be a vibrant community of photography enthusiasts, guided by a
        ...
        <div className="row">
          <div className="col-12 text-center">
            <h1 className="text-center display-6 mt-5 mb-3 ">Our Journey</h1>
            <p>
              The SIT Photography Club started with a WhatsApp group on 11th
              July 2019, expanding to Facebook and Instagram by February 2020.
              Despite the challenges posed by the COVID-19 pandemic, we kept our
              spirit alive through various online activities and competitions.
              Our community is divided into two groups: SIT PHOTO CLUB and SIT
              PHOTO CLUB (BEGINNERS), ensuring that both seasoned photographers
              and novices have a space to learn and grow.
            </p>
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-12 text-center">
            ...
            <p>
              ...
              interviews to select dedicated members. Our team members have
              taken on roles such as PR and content writers, contributing to the
              club's success.
            </p>
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-12 text-center">
            ...
            <p>
              ...
              our club offers a supportive environment to learn, share, and
              grow.
            </p>
          </div>
        </div>

        <div className="mt-5 mb-3 text-center d-flex justify-content-center align-items-center gap-2">
          {/* love icon start */}
          <svg
